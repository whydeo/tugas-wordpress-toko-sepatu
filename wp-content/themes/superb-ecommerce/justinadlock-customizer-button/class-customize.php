...
final class superb_ecommerce_theme_Customize {
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_style( 'superb-ecommerce-customize-controls', trailingslashit( get_template_directory_uri() ) . 'justinadlock-customizer-button/customize-controls.css', array(), "3.0");
	}
}
